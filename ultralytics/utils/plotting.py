...
class Annotator:
    ...
    def count_labels(self, in_count=0, out_count=0, color=(255, 255, 255), txt_color=(0, 0, 0)):
        ...
        cv2.rectangle(
            self.im, (text_x1 - 5, text_y - 5), (text_x1 + text_width + 7, text_y + t_size_in[1] + 7), color, -1
        )
        cv2.putText(
            self.im,
            str(in_count),
            (text_x1, text_y + t_size_in[1]),
            0,
            tl / 2,
            txt_color,
            self.tf,
        ...
        cv2.rectangle(
            self.im, (text_x2 - 5, text_y - 5), (text_x2 + text_width + 7, text_y + t_size_out[1] + 7), color, -1
        )
        cv2.putText(
            self.im,
            str(out_count),
            (text_x2, text_y + t_size_out[1]),
            0,
            tl / 2,
            txt_color,
            thickness=self.tf,
